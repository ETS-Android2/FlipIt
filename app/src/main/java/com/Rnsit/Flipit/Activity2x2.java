...
public class Activity2x2 extends AppCompatActivity {
    ...
    int cardNumber = 1;
    int points = 0;
    int backgroundImage[] = {R.drawable.orange1, R.drawable.red1, R.drawable.green1};
    int counterAttempts;
    long startTime = 0;
    int timerCounter = 0;

    TextView textViewTimer, textViewAttempts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewAttempts = (TextView) findViewById(R.id.textViewTentativi);
        ...
        frontOfCardsResources(); // loading images
        Collections.shuffle(Arrays.asList(cardsArray)); // shuffle
    ...
    public void sameCard() {
        counterAttempts++;
        textViewAttempts.setText(counterAttempts + " ");
        if (firstCard == secondCard) {
            sameClicked();
            points++;
    ...
    public void checkEnd() {
        if (imageView11.getVisibility() == View.INVISIBLE &&
            ...
            alerDialogBuilder
                    .setMessage("Game over in "+ textViewTimer.getText() + "!!!\nYou concluded by discovering the " + points + " couples in " + counterAttempts + " attempts" + "\nWhat do you want to do?")
                    .setCancelable(false)
